          ...
          <tr>
            ...
            <td>
              <a class="btn btn-secondary"
                href="{{ route('example-blog.teams.tags.show', [$team->id, $tag->id]) }}">
                {{ __('my_app.crud.show') }}
              </a>
              <a class="btn btn-success"
                href="{{ route('example-blog.teams.tags.edit', [$team->id, $tag->id]) }}">
                {{ __('my_app.crud.edit') }}
              </a>
              {{ Form::open([
                'route' => ['example-blog.teams.tags.destroy', $team->id, $tag->id],
                'method' => 'DELETE',
                'files' => false,
