...
class TagRequestTest extends TestCase
{
     ...
     */
    public function it_validate_store_tag_request($field, $formFields, $shouldPass = false)
    {
        $this->signIn();
     ...
     */
    public function it_validate_update_tag_request($field, $formFields, $shouldPass = false)
    {
        $this->signIn();
        ...
        $response = $this->updateItem($tag->id, $this->getItemFields($formFields));
    ...
    /** @test */
    public function guest_cannot_create_tag()
    {
        $attributes = $this->itemAttributes;
    ...
    public function authenticated_user_can_update_tag()
    {
        ...
        $this->updateItem($tag->id, $attributes);
    ...
    /** @test */
    public function authenticated_user_cannot_update_others_tag()
    {
        $this->signIn();
        $attributes = $this->itemAttributes;
