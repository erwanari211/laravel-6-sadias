    ...
    public function formatData($data)
    {
        ...
        return Datatables::of($data)
            ...
            ->addColumn('links', function($item) {
                $viewUrl = route('example-permission.users.show', [$item->id]);
                $editUrl = route('example-permission.users.edit', [$item->id]);
                $deleteUrl = route('example-permission.users.destroy', [$item->id]);
