    ...
    public function formatData($data)
    {
        ...
        return Datatables::of($data)
            ...
            ->addColumn('links', function($item) {
                $viewUrl = route('example-permission.roles.show', [$item->id]);
                $editUrl = route('example-permission.roles.edit', [$item->id]);
                $deleteUrl = route('example-permission.roles.destroy', [$item->id]);
