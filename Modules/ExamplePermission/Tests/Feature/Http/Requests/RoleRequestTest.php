...
class RoleRequestTest extends TestCase
{
     ...
     */
    public function it_validate_store_role_request($field, $formFields, $shouldPass = false)
    {
        $this->signIn();
     ...
     */
    public function it_validate_update_role_request($field, $formFields, $shouldPass = false)
    {
        $this->signIn();
        ...
        $response = $this->updateItem($role->id, $this->getItemFields($formFields));
    ...
    /** @test */
    public function guest_cannot_create_role()
    {
        $attributes = $this->itemAttributes;
    ...
    public function authenticated_user_can_update_role()
    {
        ...
        $this->updateItem($role->id, $attributes);
    ...
    /** @test */
    // public function authenticated_user_cannot_update_others_role()
    // {
    //     $this->signIn();
    //     $attributes = $this->itemAttributes;
