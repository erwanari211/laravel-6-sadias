...
class MakeSeeder extends Command
{
    ...
    protected $signature = 'my_app:make_seeder
                            {name : Name}
                            {--module= : Module name}
    ...
    protected $description = 'Create Custom Seeder';
    ...
    public function __construct()
    {
        ...
        $this->stubFile = $this->stubPath . 'seeder.stub';
    ...
    {
        $this->outputName = $this->data['SEEDER_CLASS'];
    }
